...
function Detail() {
  return (
    <div className='mt-5 p-5 bg-warning' >
        <p className='fw-bold fs-3 Yellow'>We Are Ready To Provide Lanyard Printing Solutions</p>
        <p className='fw-bold fs-3'>Using Modern Printing Machines</p> 
        <p className='fw-bold fs-3'>And High Quality Materials</p>
        <Row className="justify-content-md-center">
            <Col>
                <Card className='bg-warning border-warning text-white' style={{ width: '379px' }}>
                <Card.Img src={MM} fluid />
                    <Card.ImgOverlay className='position'>
                        <Card.Title className='fw-bold fs-3'>Modern Machines</Card.Title>
                        <Button className='text-white' variant="secondary">Quality</Button>
                        <Button className='text-white ms-3' variant="secondary">Production</Button>
                    </Card.ImgOverlay>
                </Card>
            </Col>
            <Col s={6}>
