    ...
    <Row className="mt-5">
      <Col xs={6} className="Text-Center">
        ...
        <p className="text-start mt-3">
          Kami menyediakan berbagai jenis lanyard dengan variasi warna, ukuran,
          dan bahan yang dapat disesuaikan dengan kebutuhan Anda. Selain itu,
          kami juga menyediakan layanan cetak logo atau gambar pada lanyard
          untuk memperkuat brand awarness Anda
        </p>
